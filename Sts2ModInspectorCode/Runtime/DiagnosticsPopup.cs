...
/// Dimmed backdrop + centered panel; patch conflicts split across two tabs: Critical and Warning.
/// Save-report / Close in the footer.</summary>
public static class DiagnosticsPopup
{
    ...
    private static void DoShow(DiagnosticResult result)
    {
        ...
        var tabs = new TabContainer { CustomMinimumSize = new Vector2(760, 440) };
        vbox.AddChild(tabs);
        ...
        tabs.CurrentTab = high.Count > 0 ? 0 : 1; // open on Critical if any, else Warning
